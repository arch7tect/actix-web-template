...
### 3. Repository Tests (19 tests)
- **File**: `tests/repository_tests.rs`
- **Purpose**: Test database access layer
- **Coverage**:
  - Database CRUD operations
  - Pagination logic
  - Filtering (by completion status, tags)
  - Sorting (by different fields, asc/desc)
  - Tag operations (create, assign, retrieve, delete)
  - Many-to-many relationships (memo_tags)
  - Tag lifecycle management (unused tag deletion)
